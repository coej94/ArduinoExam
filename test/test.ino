...
void sneak() 
   ...
   //Moving door
    ...
    delay(500);
    //hiding hand
    for(pos = 90; pos>=70; pos-=8)      
    {                                
    fingerServo.write(pos);               
    delay(15);                        
    }
    delay(100);
    for(pos = 70; pos < 90; pos += 8)  
    {                                   
